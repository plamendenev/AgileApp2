...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	//hint table
	private static final String KEY_HINTID = "hintid";
	private static final String KEY_HINTSOL = "sol";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_HINT_TABLE = "CREATE TABLE " + TABLE_HINT + "("
				+ KEY_HINTID + " INTEGER PRIMARY KEY," + KEY_FAVOURITESOL + " TEXT" + ")";
	...
	// ADDING HINT
		...
		void addHint(Hint q) {
			...
			values.put(KEY_HINTSOL, q.getSol());
			// Contact Phone
	...
	Hint getHint(int id) {
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = db.query(TABLE_HINT, new String[] {
				KEY_HINTID, KEY_HINTSOL }, KEY_HINTID
				+ "=?", new String[] { String.valueOf(id) }, null, null, null,
				null);
		if (cursor != null)
			cursor.moveToFirst();
