...
public class TestPagehtml extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_fav.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				TestModelHTML q = db.getHTML(val);
		...
		TestModelHTML q = db.getHTML(initial[count]);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagehtml.this).create();
