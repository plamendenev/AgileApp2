...
public class TestPagejava extends Activity implements OnClickListener {
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		TestModelJava q = db.getJava(j2, cat);
		// i=i+1;
		String j = q.getQues();
		t1.setText(j);
		t2.setText("   " + (j1 + 1) + "/20");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_fav.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				int val = a[click];
				TestModelJava q = db.getJava(val, cat);
		...
		int g = 0;
		List<TestModelJava> quants = db.getAllJava(cat);
		...
		TestModelJava q = db.getJava(initial[count], cat);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagejava.this).create();
