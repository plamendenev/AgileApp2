...
public class showscoreallinone extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (ul == 1) {
			...
			// db.addSbtable(new
			// sbtable("allinone","allinone",date2,score2,timetaken));
			...
			unattem.append(j + "");
			double neg1 = (((score)) - (incorrect * 0.25));

			TextView neg = (TextView) findViewById(R.id.textView6);
			neg.append(" " + neg1);
			db.addSbtable(new ModelScoreBoard("allinone", "allinone", date2, (neg1 + ""), timetaken));
		}
