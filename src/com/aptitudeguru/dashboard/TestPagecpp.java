...

{
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		TestModelCpp q = db.getCpp(j2, cat);
		// i=i+1;
		String j = q.getQues();
		t1.setText(j);
		t2.setText((j1 + 1) + "/20");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_fav.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				int val = a[click];
				TestModelCpp q = db.getCpp(val, cat);
		...
		int g = 0;
		List<TestModelCpp> Cpp = db.getAllCpp(cat);
		for (TestModelCpp cn : Cpp) {
		...
		TestModelCpp q = db.getCpp(initial[count], cat);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagecpp.this).create();
