...
public class TestPagec extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int g = 0;
		List<TestModelC> quants = db.getAllC(cat);
		...
		TestModelC q = db.getC(initial[count], cat);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagec.this).create();
