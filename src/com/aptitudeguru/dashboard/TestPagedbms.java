...
public class TestPagedbms extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_fav.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				int val = a[click];
				TestModelDBMS q = db.getDBMS(val);
		...
		TestModelDBMS q = db.getDBMS(initial[count]);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagedbms.this).create();
