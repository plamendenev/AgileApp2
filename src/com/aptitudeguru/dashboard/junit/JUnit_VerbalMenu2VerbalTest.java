...
public class JUnit_VerbalMenu2VerbalTest extends InstrumentationTestCase {
	...
	protected void setUp() throws Exception {
		...
		Intent intent = new Intent(this.getInstrumentation().getContext(), TestChooiceVerbal.class);
	...
	public void testActivities() throws Exception {
		this.doJumpTest(app, R.id.btn_v1, TestPagevl.class);
	}
