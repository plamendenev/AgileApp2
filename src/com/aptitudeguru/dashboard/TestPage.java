...

{
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		TestModelQuants q = db.getQuants(j2, cat);
		// i=i+1;
		String j = q.getQues();
		t1.setText(j);
		t2.setText("   " + (j1 + 1) + "/20");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_fav.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				int val = a[click];
				TestModelQuants q = db.getQuants(val, cat);
...
//				String sol = q.getSol();
//
//				Toast.makeText(getApplicationContext(), String.format("Hint: %s", sol),
//						Toast.LENGTH_SHORT).show();
		...
		int g = 0;
		List<TestModelQuants> quants = db.getAllQuants(cat);
		...
		TestModelQuants q = db.getQuants(initial[count], cat);
