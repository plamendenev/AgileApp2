...
public class TestPagedsa extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		TestModelDSA q = db.getDSA(initial[count]);
	...
	public class MyCountDownTimer extends CountDownTimer {
		...
		public void onFinish() {
			...
			AlertDialog alertDialog = new AlertDialog.Builder(TestPagedsa.this).create();
